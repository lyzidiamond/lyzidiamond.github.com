...
At some point during this thought process, I discovered [MaptimeSF](https://twitter.com/maptimesf), a weekly map hack night run by a few of the excellent folks over at [Stamen](https://stamen.com) in San Francsico. I heard that there were a couple similar groups popping up around the country, so I decided to get in contact about starting one in Portland. Thus was born [MaptimePDX](https://twitter.com/maptimepdx).

<blockquote class="twitter-tweet"><p>MaptimePDX is ON! Sunday 9/29, 1pm-4pm at Flux (<a href="https://t.co/aYGp0GPG3E">https://t.co/aYGp0GPG3E</a>), part of <a href="https://twitter.com/WhereCampPDX">@WhereCampPDX</a>. EXCITED! More info: <a href="https://t.co/iLH0CmtXOd">https://t.co/iLH0CmtXOd</a></p>&mdash; MaptimePDX (@MaptimePDX) <a href="https://twitter.com/MaptimePDX/statuses/382250375849320448">September 23, 2013</a></blockquote>
<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>

This past weekend was [WhereCampPDX](https://wherecamppdx.org), which seemed like the perfect time to hold the inaugural MaptimePDX event. In addition to hosting an open hack for anyone who was interested in joining us, I prepared a little exercise I've been wanting to write for a while. It's called [Learn GeoJSON](https://github.com/lyzidiamond/learn-geojson), and its goal is to teach about the principles and ideas of [git](https://git-scm.org), [GitHub](https://github.com), and [GeoJSON](https://geojson.org) without having to lead beginners through dealing with (a) code and (b) the command line. You can view the slides I used for my presentation [here](https://lyzidiamond.com/learn-geojson/).
...
But fortunately, I was surrounded by a few of the [great](https://twitter.com/reidab) [geo hackers](https://twitter.com/pdxmele) I had been so eager to recruit to MaptimePDX. And they said, "You know, geojson.io is an open source project. We can just add some code to implement line breaks, make a pull request, and see if it gets merged!"
